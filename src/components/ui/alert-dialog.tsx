...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    className={cn(
      // NOTE: Some UIs (e.g. Portfolio lightbox) render at very high z-index via Portal.
      // Keep alert dialogs above those overlays so actions (like delete confirmation) remain usable.
...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        // Must stay above Overlay and any other portaled overlays.
