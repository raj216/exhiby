      ...
      {isOpen && (
        <>
          ...
          >
            ...
            <button
              onClick={onClose}
              className="absolute top-6 right-6 p-2 rounded-full bg-surface-elevated"
            >
            ...
            <div className="text-center mb-8">
              ...
              <div className="text-4xl font-serif text-gradient-gold">
                ${price}
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <button className="w-full py-4 rounded-xl bg-foreground text-background font-semibold flex items-center justify-center gap-3">
                <Apple className="w-5 h-5" />
                Pay with Apple Pay
              </button>

              {/* Biometric / Slide to Pay */}
              <div className="relative">
                <SlideToAction
                  label="Slide to Pay"
                  completedLabel="Payment Complete!"
                  icon={<Fingerprint className="w-6 h-6 text-primary-foreground" />}
