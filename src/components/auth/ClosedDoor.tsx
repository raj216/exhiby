...
export function ClosedDoor({
  ...
  return (
    ...
    >
      ...
      >
        <motion.h1
          className="text-6xl md:text-8xl font-bold tracking-tighter font-display"
          animate={{
            textShadow: [
      ...
      {/* Invitation line */}
      <motion.p
        className="mt-2 mb-8 max-w-xs text-center text-sm md:text-base font-medium font-sans text-muted-foreground/80"
      ...
      >
        ...
        <motion.button
          className="w-full py-4 px-8 rounded-2xl font-medium bg-white text-foreground dark:text-background flex items-center justify-center gap-3 shadow-lg"
