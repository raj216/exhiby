      ...
      <div className="relative z-10 text-center max-w-md px-6">
        ...
        >
          {creatorAvatar ? (
            <img
              src={creatorAvatar}
              alt={creatorName}
              className="w-20 h-20 rounded-full mx-auto border-2 border-border shadow-lg"
            />
          ) : (
            <div className="w-20 h-20 rounded-full mx-auto bg-muted flex items-center justify-center border-2 border-border">
        ...
        >
          ...
          <p className="text-muted-foreground mb-1">
            Thanks for entering the studio.
          </p>
