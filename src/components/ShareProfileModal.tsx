          ...
          >
            ...
            >
              ...
              <div className="px-5 pb-6">
                ...
                {/* Primary CTA - Muted glow styling */}
                <motion.button
                  whileTap={{ scale: 0.98 }}
                  onClick={handleCopyLink}
                  className="w-full py-3.5 rounded-xl bg-muted/80 border border-border/50 flex items-center justify-center gap-3 hover:bg-muted transition-colors shadow-[0_0_20px_rgba(255,255,255,0.05)]"
                  style={{
                    boxShadow: "0 0 25px rgba(255, 255, 255, 0.08), inset 0 1px 0 rgba(255, 255, 255, 0.1)"
                  }}
                >
                  {copied ? (
                    <>
                      <Check className="w-5 h-5 text-green-400" />
                      <span className="text-sm font-semibold text-foreground">Copied!</span>
                    </>
                  ) : (
                    <>
                      <Copy className="w-5 h-5 text-foreground" />
                      <span className="text-sm font-semibold text-foreground">Copy Profile Link</span>
                    </>
                  )}
                </motion.button>

                {/* Secondary Action - Native Share */}
                <motion.button
                  whileTap={{ scale: 0.98 }}
                  onClick={handleNativeShare}
                  className="w-full mt-4 py-3 rounded-xl bg-carbon border border-border/30 flex items-center justify-center gap-2 hover:bg-muted/30 transition-colors"
                >
